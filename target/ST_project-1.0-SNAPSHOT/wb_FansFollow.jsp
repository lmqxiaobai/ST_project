...
<head>
    ...
    <style>
        ...
        main {
            ...
            margin-bottom: 20px;
            max-width: 850px;    /*调整微博内容框在屏幕所处位置*/
            padding: 0 20px;
            margin-left: 65px; /* 调整微博内容区域与左侧的间距 */
        }
            ...
            <c:forEach items="${users}" var="user">
                <li class="weibo-item">
                    <div class="weibo-author">
                        ...
                        <div class="author-info">
                            <span class="author-name">
                                 <a href="/ST_project/selectFansPageServlet?user1_id=${user.getUser_id()}">
                    ...
                    <div class="weibo-actions">
                        <button class="like-button">互粉</button>
                    </div>
                </li>
            </c:forEach>
        </ul>
