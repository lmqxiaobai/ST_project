                ...
                <li class="weibo-item">
                    ...
                    <div class="weibo-actions">
                        ...
                        <button class="edit-button">
                            <a href="/ST_project/selectByPostUpdateServlet?post_id=${post.post_id}">编辑</a>
                        </button>
                        <button class="delete-button">
                            <a href="/ST_project/deletePostServlet?post_id=${post.getPost_id()}" onclick="return confirm('是否确认删除？');">删除</a>
                        </button>
                    </div>
                </li>
            </c:forEach>
